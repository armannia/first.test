...
class Six_Ring : AppCompatActivity() {
    var v1 = 0 ; var v2 = 0; var v3 = 0 ; var v4 = 0.0 ; var v5 = 0.0; var v6 = 0
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_five_ring)
        ...
        val optionTemp = arrayOf("braun","rot","orange","grün","blau","violett","weiß")
        ...
        val option5 = findViewById<Spinner>(R.id.spinner)
        val option6 = findViewById<Spinner>(R.id.spinner6)

        var result1 = findViewById<TextView>(R.id.textView6)
        val result2 = findViewById<TextView>(R.id.textView62)
        val result3 = findViewById<TextView>(R.id.textView63)
        ...
        val view5 = findViewById<TextView>(R.id.textView)
        val view6 = findViewById<TextView>(R.id.textView5)
        ...
        option5.adapter = ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,optionsSilver)
        option5.adapter = ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,optionTemp)
        ...
        calc.setOnClickListener{
            val res = ""+ (v1 *100 +v2*10 + v3 )*v4 + "Ω"
            result1.text = res
            result2.text = "+/-" + v5 + "%"
            result3.text = "Temp.Koeffizient: " + v6
        }
    }
}